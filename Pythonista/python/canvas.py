...
def draw_text(text, x, y, font_name='Helvetica', font_size=16.0):
	"""draw_text(text, x, y, font_name='Helvetica', font_size=16.0) -- Draw a single
		line of text at a given point. The point represents the origin of the line,
		i.e. its lower-left corner."""
